    ...
    <div className="space-y-6">
        ...
        <div className="flex-1">
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className={`flex-1 p-3 rounded-lg border-2 transition-all ${deviceTypes.includes('mobile')
            ...
            <button
              ...
              className={`flex-1 p-3 rounded-lg border-2 transition-all ${deviceTypes.includes('residential')
                  ? 'border-purple-500 bg-purple-50 dark:bg-purple-900/30'
                  : 'border-gray-200 dark:border-gray-700'
                }`}
            >
            ...
            <button
              ...
              className={`flex-1 p-3 rounded-lg border-2 transition-all ${deviceTypes.includes('datacenter')
                  ? 'border-purple-500 bg-purple-50 dark:bg-purple-900/30'
                  : 'border-gray-200 dark:border-gray-700'
                }`}
            >
      ...
      <div className="flex gap-2 border-b">
        <button
          ...
          className={`flex items-center gap-2 px-4 py-2 border-b-2 transition-colors ${activeTab === 'country'
        ...
        <button
          ...
          className={`flex items-center gap-2 px-4 py-2 border-b-2 transition-colors ${activeTab === 'region'
              ? 'border-purple-500 text-purple-600'
        ...
        <button
          ...
          className={`flex items-center gap-2 px-4 py-2 border-b-2 transition-colors ${activeTab === 'city'
              ? 'border-purple-500 text-purple-600'
              : 'border-transparent text-gray-400'
            } disabled:opacity-50 disabled:cursor-not-allowed`}
        >
        ...
        <button
          ...
          className={`flex items-center gap-2 px-4 py-2 border-b-2 transition-colors ${activeTab === 'advanced'
              ? 'border-purple-500 text-purple-600'
              : 'border-transparent text-gray-400'
            } disabled:opacity-50 disabled:cursor-not-allowed`}
        >
                  ...
                  <div className="grid grid-cols-2 gap-2 max-h-96 overflow-y-auto">
                    {filteredStates.map((state) => (
                      <button
                        ...
                        className={`p-3 rounded-lg border text-left transition-colors disabled:opacity-50 ${selectedState?.id === state.id
                            ? 'border-purple-500 bg-purple-50 dark:bg-purple-900/30'
                  ...
                  <div className="grid grid-cols-2 gap-2 max-h-96 overflow-y-auto">
                    {filteredCities.map((city, idx) => (
                      <button
                        ...
                        className={`p-3 rounded-lg border text-left transition-colors ${selectedCity?.id === city.id
                            ? 'border-purple-500 bg-purple-50 dark:bg-purple-900/30'
                            : 'border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800'
                          }`}
                      >
